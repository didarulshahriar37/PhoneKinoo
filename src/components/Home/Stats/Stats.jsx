        ...
        <div>
            <div className='flex flex-col md:flex-row justify-center gap-10 md:gap-15 mt-10 items-center '>
                <div className='text-center'>
                    <div className='bg-red-100 px-10 py-5 rounded-2xl mb-4 transition-transform shadow-xl transform hover:scale-105 hover:shadow-2xl duration-300'>
                    ...
                    <div className='bg-green-100 px-10 py-5 rounded-2xl mb-4 shadow-xl transform hover:scale-105 hover:shadow-2xl duration-300'>
                        <div className='flex items-center justify-center gap-2 text-xl font-semibold'>
                    ...
                    <div className='bg-blue-100 px-10 py-5 rounded-2xl shadow-xl transform hover:scale-105 hover:shadow-2xl duration-300'>
                        <div className='flex items-center justify-center gap-2 text-xl font-semibold '>
                            <FaUsers />
                            <h3>5,000+ Users</h3>
                        </div>
                ...
                <div>
                    <div className='bg-orange-100 rounded-2xl p-10 shadow-xl transform hover:scale-105 hover:shadow-2xl duration-300'>
